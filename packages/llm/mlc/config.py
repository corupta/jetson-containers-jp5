...
package = [
    ...
    mlc('d2118b3', 'patches/d2118b3.diff', version='0.20.0', tvm='0.20.0', requires='>=35', depends=['flashinfer:0.2.5'], default=(L4T_VERSION.major >= 35)), # 5/1/2025
    # mlc('517d79b', 'patches/517d79b.diff', version='0.21.0', tvm='0.21.0', requires='>=35', depends=['flashinfer:0.2.6.post1'], default=(L4T_VERSION.major >= 35)), # 6/12/2025 # won't work yet
]
